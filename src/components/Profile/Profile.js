...
class Profile extends Component {
    ...
    createPost = () => {
        ...
        let shoes = this.state.createParams.shoes;
        let user_name = this.state.sessionUser;
        let post_name = user_name + " got some new gear!"
        let post_body = "Current setup: " + board + " board, " + trucks + " trucks, " + wheels + " wheels and " + bearings + " bearings and " + shoes + " shoes."
                                    ...
                                    <Col>
                                        ...
                                        <Form>
                                            <Form.Group controlId="form-stance">
                                                ...
                                                <Form.Control type="text" name='stance'
                                                    placeholder={
                                                        this.state.createParams.stance
                                                    }
                                                    onChange={
                    ...
                    <Col>
                        ...
                        <Card bg='light'
                            ...
                            <Card.Body>
                                ...
                                <Form>
                                    <Form.File id="custom-file" label="Upload Your Clip" custom/>
                                </Form>
                            </Card.Body>
                        </Card>
                    </Col>
                        ...
                        <Card bg='light'
                            ...
                            <Card.Body>
                                <Card.Text style={cardBodyStyle}>
                                    ...
                                    <br/>
                                    Trucks: {
                                    this.state.createParams.trucks
                                }
                                    <br/>
                                    Wheels: {
                                    this.state.createParams.wheels
                                }
                                    <br/>
                                    Bearings: {
                                    this.state.createParams.bearings
                                }
                                    <br/>
                                    Shoes: {
                                    this.state.createParams.shoes
                                }
                                    <br/>
                                </Card.Text>
                                <Button size="sm"
                                    ...
                                    <Col>
                                        ...
                                        <Form>
                                            <Form.Group controlId="form-board">
                                                ...
                                                <Form.Control type="text" name='board'
                                                    placeholder={
                                                        this.state.createParams.board
                                                    }
                                                    onChange={
                                            ...
                                            <Form.Group controlId="form-trucks">
                                                ...
                                                <Form.Control type="text" name='trucks'
                                                    placeholder={
                                                        this.state.createParams.trucks
                                                    }
                                                    onChange={
                                            ...
                                            <Form.Group controlId="form-wheels">
                                                ...
                                                <Form.Control type="text" name='wheels'
                                                    placeholder={
                                                        this.state.createParams.wheels
                                                    }
                                                    onChange={
                                            ...
                                            <Form.Group controlId="form-bearings">
                                                ...
                                                <Form.Control type="text" name='bearings'
                                                    placeholder={
                                                        this.state.createParams.bearings
                                                    }
                                                    onChange={
                                            ...
                                            <Form.Group controlId="form-shoes">
                                                ...
                                                <Form.Control type="text" name='shoes'
                                                    placeholder={
                                                        this.state.createParams.shoes
                                                    }
                                                    onChange={
